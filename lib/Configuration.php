...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://ninja.test';
    ...
    {
        $report  = 'PHP SDK (IvkeyMinds\InvoiceNinjaClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 5.5.58' . PHP_EOL;

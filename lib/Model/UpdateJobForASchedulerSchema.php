...
/**
 * UpdateJobForASchedulerSchema Class Doc Comment
 *
 * @category Class
 * @package  IvkeyMinds\InvoiceNinjaClient
 * @author   OpenAPI Generator team
 ...
 */
class UpdateJobForASchedulerSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateJobForASchedulerSchema';
    ...
    */
     ...
     * Sets job
     *
     * @param string|null $job Set action name, action names can be found in Scheduler Model
     *
     * @return self
     */

...
/**
 * RecurringQuote Class Doc Comment
 *
 * @category Class
 * @package  IvkeyMinds\InvoiceNinjaClient
 * @author   OpenAPI Generator team
 ...
 */
class RecurringQuote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecurringQuote';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The hashed id of the recurring quote
     *
     * @return self
     */
     ...
     * Sets status_id
     *
     * @param string|null $status_id The quote status variable
     *
     * @return self
     */
     ...
     * Sets frequency_id
     *
     * @param float|null $frequency_id The recurring quote frequency
     *
     * @return self
     */
     ...
     *
     * @param float|null $remaining_cycles The number of quotes left to be generated
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string|null $number The recurringquote number - is a unique alpha numeric number per quote per company
     *
     * @return self
     */
     ...
     * Sets po_number
     *
     * @param string|null $po_number The purchase order associated with this recurring quote
     *
     * @return self
     */
     ...
     * Sets public_notes
     *
     * @param string|null $public_notes The public notes of the quote
     *
     * @return self
     */
     ...
     * Sets private_notes
     *
     * @param string|null $private_notes The private notes of the quote
     *
     * @return self
     */
     ...
     * Sets footer
     *
     * @param string|null $footer The quote footer notes
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param object|null $line_items An array of objects which define the line items of the quote
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The quote amount
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param float|null $balance The quote balance
     *
     * @return self
     */
     ...
     * Sets paid_to_date
     *
     * @param float|null $paid_to_date The amount paid on the quote to date
     *
     * @return self
     */
     ...
     * Sets discount
     *
     * @param float|null $discount The quote discount, can be an amount or a percentage
     *
     * @return self
     */
     ...
     * Sets is_deleted
     *
     * @param bool|null $is_deleted Defines if the quote has been deleted
     *
     * @return self
     */
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date The due date of the quote
     *
     * @return self
     */

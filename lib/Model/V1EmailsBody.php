...
/**
 * V1EmailsBody Class Doc Comment
 *
 * @category Class
 * @package  IvkeyMinds\InvoiceNinjaClient
 * @author   OpenAPI Generator team
 ...
 */
class V1EmailsBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1_emails_body';
    ...
    */
     ...
     * Sets body
     *
     * @param string|null $body The email body
     *
     * @return self
     */
     ...
     * Sets entity
     *
     * @param string|null $entity The entity name
     *
     * @return self
     */
     ...
     * Sets entity_id
     *
     * @param string|null $entity_id The entity_id
     *
     * @return self
     */
     ...
     * Sets template
     *
     * @param string|null $template The template required
     *
     * @return self
     */

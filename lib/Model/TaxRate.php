...
class TaxRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Thie hashed id of the tax
     *
     * @return self
     */
     ...
     * Sets rate
     *
     * @param float|null $rate The tax rate
     *
     * @return self
     */
     ...
     * Sets is_deleted
     *
     * @param bool|null $is_deleted Boolean flag determining if the tax has been deleted
     *
     * @return self
     */

...
class Quote implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The quote hashed id
     *
     * @return self
     */
     ...
     * Sets status_id
     *
     * @param string|null $status_id The status of the quote
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string|null $number The quote number - is a unique alpha numeric number per quote per company
     *
     * @return self
     */
     ...
     * Sets po_number
     *
     * @param string|null $po_number The purchase order number associated with this quote
     *
     * @return self
     */
     ...
     * Sets terms
     *
     * @param string|null $terms The quote terms
     *
     * @return self
     */
     ...
     * Sets public_notes
     *
     * @param string|null $public_notes Public notes for the quote
     *
     * @return self
     */
     ...
     * Sets private_notes
     *
     * @param string|null $private_notes Private notes for the quote
     *
     * @return self
     */
     ...
     * Sets footer
     *
     * @param string|null $footer Footer text of quote
     *
     * @return self
     */
     ...
     * Sets total_taxes
     *
     * @param float|null $total_taxes The total taxes for the quote
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param object|null $line_items An array of line items of the quote
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The total amount of the quote
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param float|null $balance The balance due of the quote
     *
     * @return self
     */
     ...
     * Sets paid_to_date
     *
     * @param float|null $paid_to_date The amount that has been paid to date on the quote
     *
     * @return self
     */
     ...
     * Sets discount
     *
     * @param float|null $discount The quote discount
     *
     * @return self
     */
     ...
     * Sets partial
     *
     * @param float|null $partial The partial/deposit amount
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_amount_discount Boolean flag determining if the quote is an amount or percentage
     *
     * @return self
     */
     ...
     * Sets is_deleted
     *
     * @param bool|null $is_deleted Boolean flag determining if the quote has been deleted
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The Quote Date
     *
     * @return self
     */
     ...
     * Sets last_sent_date
     *
     * @param \DateTime|null $last_sent_date The last date the quote was sent out
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $partial_due_date The date when the partial/deposit is due
     *
     * @return self
     */
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date The date the quote is valid until
     *
     * @return self
     */

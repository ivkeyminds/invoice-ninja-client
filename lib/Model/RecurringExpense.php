...
/**
 * RecurringExpense Class Doc Comment
 *
 * @category Class
 * @package  IvkeyMinds\InvoiceNinjaClient
 * @author   OpenAPI Generator team
 ...
 */
class RecurringExpense implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecurringExpense';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The hashed id of the recurring expense
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string|null $user_id The hashed id of the user who created the recurring expense
     *
     * @return self
     */
     ...
     *
     * @param string|null $assigned_user_id The hashed id of the user assigned to this recurring expense
     *
     * @return self
     */
     ...
     * Sets invoice_id
     *
     * @param string|null $invoice_id The hashed id of the invoice
     *
     * @return self
     */
     ...
     * Sets bank_id
     *
     * @param string|null $bank_id The id of the bank associated with this recurring expense
     *
     * @return self
     */
     ...
     *
     * @param string|null $invoice_currency_id The currency id of the invoice associated with this recurring expense
     *
     * @return self
     */
     ...
     *
     * @param string|null $expense_currency_id The currency id of the expense associated with this recurring expense
     *
     * @return self
     */
     ...
     *
     * @param string|null $invoice_category_id The category id of the invoice
     *
     * @return self
     */
     ...
     * Sets private_notes
     *
     * @param string|null $private_notes The recurring expense private notes
     *
     * @return self
     */
     ...
     * Sets public_notes
     *
     * @param string|null $public_notes The recurring expense public notes
     *
     * @return self
     */
     ...
     *
     * @param string|null $transaction_reference The recurring expense transaction reference
     *
     * @return self
     */
     ...
     * Sets transcation_id
     *
     * @param string|null $transcation_id The transaction id of the recurring expense
     *
     * @return self
     */
     ...
     * Sets custom_value1
     *
     * @param string|null $custom_value1 Custom value field
     *
     * @return self
     */
     ...
     * Sets custom_value2
     *
     * @param string|null $custom_value2 Custom value field
     *
     * @return self
     */
     ...
     * Sets custom_value3
     *
     * @param string|null $custom_value3 Custom value field
     *
     * @return self
     */
     ...
     * Sets custom_value4
     *
     * @param string|null $custom_value4 Custom value field
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The total amount of the recurring expense
     *
     * @return self
     */
     ...
     * Sets frequency_id
     *
     * @param float|null $frequency_id The frequency this recurring expense fires
     *
     * @return self
     */
     ...
     *
     * @param float|null $remaining_cycles The number of remaining cycles for this recurring expense
     *
     * @return self
     */
     ...
     * Sets foreign_amount
     *
     * @param float|null $foreign_amount The foreign currency amount of the recurring expense
     *
     * @return self
     */
     ...
     * Sets exchange_rate
     *
     * @param float|null $exchange_rate The exchange rate for the expernse
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param string|null $date The date of the expense
     *
     * @return self
     */
     ...
     * Sets payment_date
     *
     * @param string|null $payment_date The date the expense was paid
     *
     * @return self
     */
     ...
     *
     * @param bool|null $should_be_invoiced Boolean flag determining if the expense should be invoiced
     *
     * @return self
     */
     ...
     * Sets is_deleted
     *
     * @param bool|null $is_deleted Boolean flag determining if the recurring expense is deleted
     *
     * @return self
     */
     ...
     * Sets last_sent_date
     *
     * @param \DateTime|null $last_sent_date The Date it was sent last
     *
     * @return self
     */
     ...
     * Sets next_send_date
     *
     * @param \DateTime|null $next_send_date The next send date
     *
     * @return self
     */
     ...
     *
     * @param bool|null $invoice_documents Boolean flag determining if the documents associated with this expense should be passed onto the invoice if it is converted to an invoice
     *
     * @return self
     */

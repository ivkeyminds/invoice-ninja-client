...
/**
 * V1SignupBody Class Doc Comment
 *
 * @category Class
 * @package  IvkeyMinds\InvoiceNinjaClient
 * @author   OpenAPI Generator team
 ...
 */
class V1SignupBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1_signup_body';
    ...
    */
     ...
     * Sets first_name
     *
     * @param string|null $first_name The signup users first name
     *
     * @return self
     */
     ...
     * Sets last_name
     *
     * @param string|null $last_name The signup users last name
     *
     * @return self
     */
     ...
     *
     * @param bool|null $terms_of_service The user accepted the terms of service
     *
     * @return self
     */
     ...
     * Sets privacy_policy
     *
     * @param bool|null $privacy_policy The user accepted the privacy policy
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password The user password must meet minimum criteria ~ >6 characters
     *
     * @return self
     */

 ...
 */
class BTRules implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BTRules';
    ...
    {
        $this->setIfExists('data_key', $data ?? [], null);
    ...
    */
     ...
     * Sets data_key
     *
     * @param string|null $data_key The key to search
     *
     * @return self
     */
     ...
     * Sets operator
     *
     * @param string|null $operator The operator flag of the search
     *
     * @return self
     */

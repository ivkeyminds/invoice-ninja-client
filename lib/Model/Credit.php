...
class Credit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The credit hashed id
     *
     * @return self
     */
     ...
     * Sets status_id
     *
     * @param string|null $status_id The status field id infors of the current status of the credit
     *
     * @return self
     */
     ...
     * Sets invoice_id
     *
     * @param string|null $invoice_id The linked invoice this credit is applied to
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string|null $number The credit number - is a unique alpha numeric number per credit per company
     *
     * @return self
     */
     ...
     * Sets po_number
     *
     * @param string|null $po_number The purchase order number this credit refers to
     *
     * @return self
     */
     ...
     * Sets terms
     *
     * @param string|null $terms The credit terms field
     *
     * @return self
     */
     ...
     * Sets public_notes
     *
     * @param string|null $public_notes The public notes field of the credit
     *
     * @return self
     */
     ...
     * Sets private_notes
     *
     * @param string|null $private_notes The private notes field of the credit
     *
     * @return self
     */
     ...
     * Sets footer
     *
     * @param string|null $footer The credit footer text
     *
     * @return self
     */
     ...
     * Sets tax_name2
     *
     * @param string|null $tax_name2 The tax rate
     *
     * @return self
     */
     ...
     * Sets tax_rate1
     *
     * @param float|null $tax_rate1 The tax name
     *
     * @return self
     */
     ...
     * Sets total_taxes
     *
     * @param float|null $total_taxes The total taxes for the credit
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param object|null $line_items The line items array containing the line items of the credit
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount The total credit amount
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param float|null $balance The credit balance
     *
     * @return self
     */
     ...
     * Sets paid_to_date
     *
     * @param float|null $paid_to_date _________
     *
     * @return self
     */
     ...
     * Sets is_deleted
     *
     * @param bool|null $is_deleted _________
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The Credit Date
     *
     * @return self
     */
     ...
     * Sets last_sent_date
     *
     * @param \DateTime|null $last_sent_date The last date the credit was sent out
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $partial_due_date _________
     *
     * @return self
     */
     ...
     * Sets due_date
     *
     * @param \DateTime|null $due_date _________
     *
     * @return self
     */

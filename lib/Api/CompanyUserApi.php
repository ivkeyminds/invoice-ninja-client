...
class CompanyUserApi
{
     ...
     */
    public function updateCompanyUser($x_requested_with, string $contentType = self::contentTypes['updateCompanyUser'][0])
    {
        list($response) = $this->updateCompanyUserWithHttpInfo($x_requested_with, $contentType);
        return $response;
    }
     ...
     */
    public function updateCompanyUserWithHttpInfo($x_requested_with, string $contentType = self::contentTypes['updateCompanyUser'][0])
    {
        $request = $this->updateCompanyUserRequest($x_requested_with, $contentType);
     ...
     */
    public function updateCompanyUserAsync($x_requested_with, string $contentType = self::contentTypes['updateCompanyUser'][0])
    {
        return $this->updateCompanyUserAsyncWithHttpInfo($x_requested_with, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCompanyUserAsyncWithHttpInfo($x_requested_with, string $contentType = self::contentTypes['updateCompanyUser'][0])
    {
        $returnType = '\IvkeyMinds\InvoiceNinjaClient\Model\CompanyUser';
        $request = $this->updateCompanyUserRequest($x_requested_with, $contentType);
     ...
     */
    public function updateCompanyUserRequest($x_requested_with, string $contentType = self::contentTypes['updateCompanyUser'][0])
    {
        ...
        if ($x_requested_with === null || (is_array($x_requested_with) && count($x_requested_with) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_requested_with when calling updateCompanyUser'
            );
        }


        $resourcePath = '/api/v1/company_users';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

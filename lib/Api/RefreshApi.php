...
class RefreshApi
{
     ...
     */
    public function refresh($x_api_token, $x_requested_with, $include = null, $include_static = null, $clear_cache = null, string $contentType = self::contentTypes['refresh'][0])
    {
        list($response) = $this->refreshWithHttpInfo($x_api_token, $x_requested_with, $include, $include_static, $clear_cache, $contentType);
        return $response;
    }
     ...
     */
    public function refreshWithHttpInfo($x_api_token, $x_requested_with, $include = null, $include_static = null, $clear_cache = null, string $contentType = self::contentTypes['refresh'][0])
    {
        $request = $this->refreshRequest($x_api_token, $x_requested_with, $include, $include_static, $clear_cache, $contentType);
     ...
     */
    public function refreshAsync($x_api_token, $x_requested_with, $include = null, $include_static = null, $clear_cache = null, string $contentType = self::contentTypes['refresh'][0])
    {
        return $this->refreshAsyncWithHttpInfo($x_api_token, $x_requested_with, $include, $include_static, $clear_cache, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function refreshAsyncWithHttpInfo($x_api_token, $x_requested_with, $include = null, $include_static = null, $clear_cache = null, string $contentType = self::contentTypes['refresh'][0])
    {
        $returnType = '\IvkeyMinds\InvoiceNinjaClient\Model\CompanyUser';
        $request = $this->refreshRequest($x_api_token, $x_requested_with, $include, $include_static, $clear_cache, $contentType);
     ...
     */
    public function refreshRequest($x_api_token, $x_requested_with, $include = null, $include_static = null, $clear_cache = null, string $contentType = self::contentTypes['refresh'][0])
    {

        // verify the required parameter 'x_api_token' is set
        if ($x_api_token === null || (is_array($x_api_token) && count($x_api_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_api_token when calling refresh'
            );
        }
        ...
        if ($x_requested_with === null || (is_array($x_requested_with) && count($x_requested_with) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_requested_with when calling refresh'
            );
        }

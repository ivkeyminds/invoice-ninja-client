...
class LogoutApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getLogout'] to see the possible values for this operation
     *
     ...
     * @return void
     */
    public function getLogout($x_api_token, $x_requested_with, $include = null, $index = null, string $contentType = self::contentTypes['getLogout'][0])
    {
        $this->getLogoutWithHttpInfo($x_api_token, $x_requested_with, $include, $index, $contentType);
    }
     ...
     */
    public function getLogoutWithHttpInfo($x_api_token, $x_requested_with, $include = null, $index = null, string $contentType = self::contentTypes['getLogout'][0])
    {
        $request = $this->getLogoutRequest($x_api_token, $x_requested_with, $include, $index, $contentType);
     ...
     */
    public function getLogoutAsync($x_api_token, $x_requested_with, $include = null, $index = null, string $contentType = self::contentTypes['getLogout'][0])
    {
        return $this->getLogoutAsyncWithHttpInfo($x_api_token, $x_requested_with, $include, $index, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLogoutAsyncWithHttpInfo($x_api_token, $x_requested_with, $include = null, $index = null, string $contentType = self::contentTypes['getLogout'][0])
    {
        $returnType = '';
        $request = $this->getLogoutRequest($x_api_token, $x_requested_with, $include, $index, $contentType);
     ...
     */
    public function getLogoutRequest($x_api_token, $x_requested_with, $include = null, $index = null, string $contentType = self::contentTypes['getLogout'][0])
    {

        // verify the required parameter 'x_api_token' is set
        if ($x_api_token === null || (is_array($x_api_token) && count($x_api_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_api_token when calling getLogout'
            );
        }
        ...
        if ($x_requested_with === null || (is_array($x_requested_with) && count($x_requested_with) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_requested_with when calling getLogout'
            );
        }
